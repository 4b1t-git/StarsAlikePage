...
function FloatingToolbar() {
  return (
    <div className="absolute bottom-6 left-1/2 -translate-x-1/2 z-30 flex h-[52px] w-max max-w-full overflow-x-auto no-scrollbar items-center gap-1 rounded-[14px] bg-cosmos-smoke px-3 shadow-[0_20px_40px_rgba(0,0,0,0.5)] font-[family-name:var(--font-sans)] text-mockup-ink-soft ring-1 ring-white/10 transition-transform duration-500 hover:scale-[1.02]">
      <button className="h-9 px-3 hover:text-mockup-ink transition-colors text-[13px]">H1</button>
      <button className="h-9 px-3 hover:text-mockup-ink transition-colors text-[13px]">H2</button>
      <div className="w-[1px] h-6 bg-mockup-panel mx-1.5 shrink-0" />
      <button className="h-9 w-9 flex shrink-0 items-center justify-center hover:text-mockup-ink transition-colors font-serif font-bold text-[15px]">B</button>
      <button className="h-9 w-9 flex shrink-0 items-center justify-center hover:text-mockup-ink transition-colors font-serif italic text-[15px]">I</button>
      <button className="h-9 w-9 flex shrink-0 items-center justify-center hover:text-mockup-ink transition-colors font-serif underline text-[15px]">U</button>
      <button className="h-9 w-9 flex shrink-0 items-center justify-center hover:text-mockup-ink transition-colors font-serif line-through text-[15px]">S</button>
      <div className="w-[1px] h-6 bg-mockup-panel mx-1.5 shrink-0" />
      <button className="h-9 w-9 flex shrink-0 items-center justify-center hover:text-mockup-ink transition-colors">
      ...
      <button className="h-9 w-9 flex shrink-0 items-center justify-center bg-star-dim text-mockup-ink rounded-[8px]">
      ...
      <div className="w-[1px] h-6 bg-mockup-panel mx-1.5 shrink-0" />
      <button className="h-9 w-9 flex shrink-0 items-center justify-center hover:text-mockup-ink transition-colors font-serif text-[20px]">”</button>
      <button className="h-9 w-9 flex shrink-0 items-center justify-center hover:text-mockup-ink transition-colors font-mono text-[14px] font-bold">&lt;&gt;</button>
      <button className="h-9 w-9 flex shrink-0 items-center justify-center hover:text-mockup-ink transition-colors">
      ...
      <button className="h-9 w-9 flex shrink-0 items-center justify-center hover:text-mockup-ink transition-colors font-mono font-bold text-[16px]">/</button>
      <div className="w-[1px] h-6 bg-mockup-panel mx-1.5 shrink-0" />
      <button className="h-9 px-3 flex shrink-0 items-center justify-center hover:text-mockup-ink transition-colors text-[14px] font-medium">Aa</button>
      <button className="h-9 px-3 flex shrink-0 items-center justify-center hover:text-mockup-ink transition-colors">
        <span className="text-[15px] font-bold border-b-2 border-mockup-hairline leading-tight pb-[2px]">A</span>
      </button>
    </div>
  );
}
...
function ArbolContent({ setView }: { setView: (v: ViewState) => void }) {
  return (
    <div className="relative flex aspect-[16/10] w-full overflow-hidden rounded-[16px] sm:rounded-[22px] bg-cosmos-void">
      <div className="absolute inset-0 z-0 bg-gradient-to-r from-black/80 via-black/50 to-transparent" />
      
      {/* LEFT SIDEBAR */}
      <div className="relative z-10 flex h-full w-[300px] shrink-0 font-[family-name:var(--font-sans)] text-mockup-ink-soft bg-cosmos-void">
        {/* Nav strip */}
        <div className="flex w-[48px] flex-col items-center py-6 relative">
          <div className="h-7 w-7 shrink-0 overflow-hidden rounded-full ring-1 ring-star/40 bg-cosmos-smoke z-10 mb-8 shadow-[0_0_15px_var(--color-star-soft)]">
          ...
          <div className="relative flex flex-1 flex-col items-center justify-between py-10 w-full z-10">
            <div className="absolute top-0 bottom-0 w-[1px] bg-mockup-panel -z-10" />
            <span className="h-1.5 w-1.5 rounded-full bg-mockup-panel" />
        ...
        <div className="flex flex-1 flex-col py-8 pr-6 pl-2">
          <div className="flex items-center gap-2 text-[10px] font-[family-name:var(--font-pixel)] tracking-widest text-mockup-ink-ghost">
          ...
          <div className="mt-10">
            <span className="mb-4 block text-[9px] font-[family-name:var(--font-pixel)] uppercase tracking-[0.25em] text-mockup-ink-ghost">Acciones</span>
            <div className="flex flex-col gap-5 text-[12px] font-medium text-mockup-ink-soft">
              <button className="flex items-center justify-between hover:text-mockup-ink transition-colors text-left w-full group">
              ...
              <button className="flex items-center gap-3 hover:text-mockup-ink transition-colors text-left">
          ...
          <div className="my-8 h-[1px] w-full bg-mockup-panel" />

          <div>
            <span className="mb-4 block text-[9px] font-[family-name:var(--font-pixel)] uppercase tracking-[0.25em] text-mockup-ink-ghost">Información</span>
            <div className="flex flex-col gap-3 text-[12px] text-mockup-ink-ghost">
              <div className="flex justify-between items-center">
                <span>Creada</span>
                <span className="text-mockup-ink-soft font-mono text-[11px]">22 jun</span>
              </div>
              <div className="flex justify-between items-center">
                <span>Palabras</span>
                <span className="text-mockup-ink-soft font-mono text-[11px]">127</span>
              </div>
              <div className="flex justify-between items-center">
                <span>Enlaces</span>
                <span className="text-mockup-ink-soft font-mono text-[11px]">3</span>
              </div>
            </div>
          </div>
          ...
          <div className="mt-8">
            <div className="flex items-center justify-between mb-3">
              <span className="block text-[9px] font-[family-name:var(--font-pixel)] uppercase tracking-[0.25em] text-mockup-ink-ghost">Etiquetas</span>
              <button className="flex h-[18px] w-[18px] items-center justify-center rounded-full bg-mockup-panel text-mockup-ink-ghost hover:bg-mockup-panel hover:text-mockup-ink transition-colors">
                <svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M12 5v14M5 12h14"/></svg>
              </button>
            </div>
            <div className="flex flex-wrap gap-2">
              <div className="flex items-center justify-between w-full rounded-lg bg-cosmos-smoke/80 backdrop-blur-sm border border-mockup-hairline px-3 py-2 text-[12px] text-mockup-ink-ghost">
                <div className="flex items-center gap-2">
                  <span className="h-1.5 w-1.5 rounded-full bg-star" />
                  #Historia
                </div>
                <button className="text-mockup-ink-ghost hover:text-mockup-ink-ghost transition-colors">
      ...
      <div className="relative z-10 flex-1 p-3 pl-0 h-full">
        <div className="w-full h-full bg-paper-bright rounded-[18px] p-10 sm:p-14 overflow-hidden relative shadow-[-10px_0_40px_rgba(0,0,0,0.6)] flex flex-col items-center">
          
          <div className="absolute inset-0 pointer-events-none opacity-[0.25]"
            style={{
              backgroundImage: `linear-gradient(to right, var(--color-paper-edge) 1px, transparent 1px), linear-gradient(to bottom, var(--color-paper-edge) 1px, transparent 1px)`,
              backgroundSize: `12px 12px`
            }}
          />
          
          <div className="relative z-10 w-full max-w-[700px] h-full flex flex-col text-[var(--color-paper-ink)] overflow-y-auto no-scrollbar">
            <h1 className="text-center font-[family-name:var(--font-serif)] text-[42px] italic font-light mb-14 text-paper-ink">
              El árbol
            </h1>
            <div className="font-[family-name:var(--font-serif)] text-[14px] sm:text-[15px] leading-[2.2] flex flex-col gap-12 relative w-full">
              <div className="relative flex gap-4 w-full">
                <span className="text-[12px] text-paper-ink/30 select-none mt-[6px] font-mono shrink-0">=</span>
              ...
              <div className="relative flex w-full items-start gap-4 pl-[28px]">
                <div className="flex-1 mt-[18px]">
                  <div className="h-[1px] w-full bg-paper-ink/20" />
                </div>
  ...
  return (
    <div className="relative flex aspect-[16/10] w-full overflow-hidden rounded-[16px] sm:rounded-[22px] bg-cosmos-void">
      ...
      <div className="relative z-10 flex h-full w-[300px] shrink-0 font-[family-name:var(--font-sans)] text-mockup-ink-soft bg-cosmos-void">
        ...
        {/* Sidebar content */}
        <div className="flex flex-1 flex-col py-8 pr-6 pl-2">
          <div className="flex items-center gap-2 text-[10px] font-[family-name:var(--font-pixel)] tracking-widest text-mockup-ink-ghost cursor-pointer hover:text-mockup-ink transition-colors" onClick={(e) => { e.stopPropagation(); setView("arbol"); }}>
            <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="m15 18-6-6 6-6"/></svg>
            <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M14 2H6a2 2 0 0 0-2 2v16c0 1.1.9 2 2 2h12a2 2 0 0 0 2-2V8l-6-6z"/><path d="M14 3v5h5"/></svg>
          ...
          <div>
            ...
            <div className="flex flex-col gap-3 text-[12px] text-mockup-ink-ghost">
              ...
              <div className="flex justify-between items-center">
                <span>Palabras</span>
                <span className="text-mockup-ink-soft font-mono text-[11px]">17</span>
              </div>
              <div className="flex justify-between items-center">
                <span>Enlaces</span>
                <span className="text-mockup-ink-soft font-mono text-[11px]">0</span>
              </div>
            </div>
          </div>
          ...
          <div className="mt-8">
            <span className="mb-3 block text-[9px] font-[family-name:var(--font-pixel)] uppercase tracking-[0.25em] text-mockup-ink-ghost">Referencias</span>
            <button onClick={(e) => { e.stopPropagation(); setView("arbol"); }} className="w-full flex items-center gap-2 rounded-lg bg-cosmos-smoke/80 backdrop-blur-sm border border-mockup-hairline px-3 py-2.5 text-[12px] text-mockup-ink-ghost hover:bg-mockup-panel hover:text-mockup-ink transition-colors group">
        ...
        <div className="w-full h-full bg-paper-bright rounded-[18px] p-10 sm:p-14 overflow-hidden relative shadow-[-10px_0_40px_rgba(0,0,0,0.6)] flex flex-col items-center">
          ...
          <div className="relative z-10 w-full max-w-[700px] h-full flex flex-col text-[var(--color-paper-ink)] overflow-y-auto no-scrollbar">
            ...
            <div className="mt-24 w-full">
              <div className="text-[10px] tracking-[0.25em] uppercase font-[family-name:var(--font-pixel)] text-paper-ink/40 mb-6 border-t border-paper-ink/10 pt-6">Referencias</div>
              <button onClick={(e) => { e.stopPropagation(); setView("arbol"); }} className="flex items-center gap-4 w-full bg-star/10 ring-1 ring-star/20 rounded-xl p-4 hover:bg-star/20 hover:ring-star/40 shadow-sm transition-all text-left group">
                ...
                <div className="font-[family-name:var(--font-serif)]">
                  <div className="text-paper-ink text-[16px] font-medium group-hover:text-star transition-colors leading-tight mb-0.5">El árbol</div>
                  <div className="text-paper-ink/50 text-[12px] italic">Historias</div>
                </div>
              </button>
            </div>
          </div>
...
export default function EditorMockup() {
  ...
  const transitionCSS = 'transform 0.8s cubic-bezier(0.25, 1, 0.5, 1), opacity 0.8s cubic-bezier(0.25, 1, 0.5, 1), filter 0.8s cubic-bezier(0.25, 1, 0.5, 1)';
    ...
    <div className="mx-auto max-w-[1200px] px-4 sm:px-6 mt-16 pb-24 overflow-hidden xl:overflow-visible">
      ...
      >
        ...
        <div 
          ...
          style={isArbol ? activeStyle : inactiveStyle}
        >
          <TabletFrame>
