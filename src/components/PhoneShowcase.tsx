...
function StatusBar() {
  return (
    <div className="flex h-[28px] items-center justify-between px-[18px] pt-[4px]">
      ...
      <span className="flex items-center gap-[5px] text-white/80">
...
function StatI({ value, label, accent }: { value: string; label: string; accent?: boolean }) {
  return (
    <div className="flex flex-col items-center px-[7px]">
      <span className="font-[family-name:var(--font-serif)] text-[16px] leading-[16px]" style={accent ? { color: "var(--color-star)", fontStyle: "italic" } : { color: "#fff" }}>{value}</span>
      <span className="mt-[2px] font-[family-name:var(--font-pixel)] text-[7px] tracking-[0.14em] text-white/40">{label}</span>
    </div>
  );
}
const Sep = () => <span className="h-[20px] w-px bg-white/[0.16]" />;

function SortBtn({ on, children }: { on?: boolean; children: React.ReactNode }) {
  return <span className={`flex h-[26px] w-[26px] items-center justify-center rounded-[6px] ${on ? "bg-star/15 text-star" : "text-white/40"}`}>{children}</span>;
}
  ...
  return (
    <>
      ...
      <div className="flex flex-col items-center px-[16px] pt-[34px] text-center">
        ...
        <h3 className="mt-[10px] font-[family-name:var(--font-serif)] text-[26px] font-light leading-[27px] text-white">Buenas tardes</h3>
        ...
        <div className="mt-[16px] flex items-center gap-[8px] rounded-full border-[0.5px] border-white/10 bg-[#050508]/40 px-[10px] py-[8px]">
      ...
      <div className="mt-[22px] flex items-center px-[16px]">
        <span className="font-[family-name:var(--font-pixel)] text-[11px] tracking-[0.22em] text-white/[0.38]">ÚLTIMOS DIARIOS</span>
        <span className="ml-[10px] h-px flex-1 bg-white/10" />
      </div>

      <div className="mt-[14px] flex gap-[12px] px-[16px]">
        {RECENT.map((d) => (
          <div key={d.title} className="relative h-[206px] w-[150px] shrink-0 overflow-hidden rounded-[13px] bg-[#111118]">
            ...
            <span className="absolute left-[13px] bottom-[8px] font-[family-name:var(--font-pixel)] text-[8px] tracking-[0.1em] text-white/55">{d.meta}</span>
      ...
      <div className="mt-[18px] px-[16px]">
        <div className="paper-grain rounded-[14px] px-[16px] py-[14px] shadow-[0_14px_30px_rgba(0,0,0,0.45)]">
          ...
          <div className="flex items-center justify-between">
            ...
            <span className="ml-[8px] flex shrink-0 items-center gap-[2px] font-[family-name:var(--font-sans)] text-[11px] font-semibold" style={{ color: "#176B62" }}>Retomar →</span>
          </div>
        </div>
      </div>

      <div className="absolute bottom-[100px] left-[16px] z-20 flex h-[44px] w-[106px] items-center gap-[6px] overflow-hidden rounded-full bg-[#11111B] px-[16px] shadow-[0_8px_22px_rgba(0,0,0,0.5)]">
        ...
        <span className="font-[family-name:var(--font-serif)] text-[13px] font-medium text-white/90">Enfoque</span>
  ...
  return (
    <>
      ...
      <div className="relative h-[126px]">
        <span className="absolute left-[14px] top-[8px] flex h-8 w-8 items-center justify-center rounded-full border-[0.5px] border-white/[0.12] bg-white/[0.04] text-white/70">
        ...
        <span className="absolute right-[14px] top-[8px] flex h-8 w-8 items-center justify-center rounded-full border-[0.5px] border-white/[0.12] bg-white/[0.04] text-white/70">
        ...
        <span className="absolute inset-x-0 bottom-0 h-[90px]" style={{ background: "linear-gradient(to bottom, transparent, #050505)" }} />
        <div className="absolute inset-x-0 bottom-[12px] flex flex-col items-center">
          ...
          <div className="mt-[8px] flex items-center rounded-full border-[0.5px] border-white/10 bg-[#050508]/55 px-[12px] py-[7px]">
      ...
      <div className="mt-[14px] flex items-center px-[16px]">
        <span className="font-[family-name:var(--font-pixel)] text-[11px] tracking-[0.21em] text-white/[0.42]">MIS DIARIOS</span>
...
function PhoneConstelacion() {
  const delay = useSyncedAnimationDelay();
  return (
    <div className="absolute inset-0 font-[family-name:var(--font-sans)] text-paper-bright">
      {/* Header */}
      <div className="px-[20px] pt-[38px]">
        <div className="flex items-start justify-between">
          <div>
            ...
            <h1 className="mt-1 font-[family-name:var(--font-serif)] text-[28px] font-light leading-tight text-white">
          ...
          <div className="mt-1 flex gap-[6px]">
            ...
            <span className="flex h-[34px] w-[34px] items-center justify-center rounded-xl border border-white/10 bg-white/[0.03] text-white/70">
        ...
        {/* Stats */}
        <div className="mt-3 flex items-center gap-[14px] rounded-full border-[0.5px] border-white/10 bg-[#050508]/55 px-[14px] py-[8px] w-fit">
          <div className="text-center">
            <span className="block font-[family-name:var(--font-serif)] text-[16px] text-white">8</span>
            <span className="font-[family-name:var(--font-pixel)] text-[8px] tracking-widest text-white/50">DIARIOS</span>
          </div>
          <div className="h-[20px] w-px bg-white/10" />
          <div className="text-center">
            <span className="block font-[family-name:var(--font-serif)] text-[16px] text-white">88</span>
            <span className="font-[family-name:var(--font-pixel)] text-[8px] tracking-widest text-white/50">PÁGINAS</span>
          </div>
          <div className="h-[20px] w-px bg-white/10" />
          <div className="text-center">
            <span className="block font-[family-name:var(--font-serif)] text-[16px] text-white">4</span>
            <span className="font-[family-name:var(--font-pixel)] text-[8px] tracking-widest text-white/50">ETIQUETAS</span>
          </div>
        </div>

        {/* Search bar */}
        <div className="mt-3 flex items-center gap-2 rounded-xl border border-white/10 bg-white/[0.03] px-3 py-[10px]">
          <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="text-white/40"><circle cx="11" cy="11" r="7"/><path d="m20 20-3-3"/></svg>
          <span className="text-[12px] text-white/40">Buscar nodo, página o etiqueta...</span>
        </div>
      </div>
      ...
      <div className="absolute top-[230px] left-0 right-0 bottom-[84px] pointer-events-none">
        <div className="absolute inset-0 blur-[6px] opacity-35">
          <svg className="h-full w-full" viewBox="0 0 360 400">
            ...
            <text x="80" y="148" textAnchor="middle" fill="white" fontSize="8" opacity="0.6">Compras</text>
            ...
            <text x="200" y="112" textAnchor="middle" fill="white" fontSize="8" opacity="0.6">Historias</text>
            ...
            <line x1="80" y1="120" x2="200" y2="80" stroke="rgba(255,255,255,0.12)" strokeWidth="0.5" />
            <line x1="200" y1="80" x2="300" y2="140" stroke="rgba(255,255,255,0.12)" strokeWidth="0.5" />
            <line x1="150" y1="250" x2="260" y2="280" stroke="rgba(255,255,255,0.12)" strokeWidth="0.5" />
            <line x1="80" y1="120" x2="150" y2="250" stroke="rgba(255,255,255,0.12)" strokeWidth="0.5" />
            <line x1="200" y1="80" x2="260" y2="280" stroke="rgba(255,255,255,0.12)" strokeWidth="0.5" />

            {[40, 120, 180, 310, 70].map((x, i) => (
              <circle key={i} cx={x} cy={[320, 50, 350, 300, 200][i]} r="2" fill="white" opacity="0.3" />
            ))}
          </svg>
        </div>

        <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-auto">
          <div className="flex flex-col items-center rounded-2xl border border-white/10 bg-[#050508]/60 px-6 py-6 shadow-2xl backdrop-blur-xl mx-6">
            ...
            <h3 className="font-[family-name:var(--font-serif)] text-[20px] text-white">
              Descubre tu universo
            </h3>
            <p className="mt-2 max-w-[240px] text-center font-[family-name:var(--font-sans)] text-[12px] text-white/70 leading-snug">
              Instala la aplicación para ver tu propia constelación de diarios, notas y etiquetas interconectadas.
            </p>
            <button className="mt-5 rounded-full bg-star px-6 py-2.5 font-[family-name:var(--font-sans)] text-[12px] font-semibold text-black shadow-[0_0_16px_var(--color-star)] transition-transform hover:scale-105 active:scale-95">
      ...
      {/* Legend */}
      <div className="absolute bottom-[90px] left-1/2 -translate-x-1/2 z-20 flex flex-wrap items-center justify-center gap-x-[16px] gap-y-[6px] rounded-full border border-white/10 bg-[#050508]/80 px-[16px] py-[8px] backdrop-blur-md">
        <div className="flex items-center gap-1.5">
          <span className="block h-[8px] w-[8px] rounded-full bg-[#60a5fa]" />
          <span className="font-[family-name:var(--font-pixel)] text-[8px] tracking-wider text-white/80">Diario</span>
        </div>
        <div className="flex items-center gap-1.5">
          <span className="block h-[6px] w-[6px] rounded-full bg-white" />
          <span className="font-[family-name:var(--font-pixel)] text-[8px] tracking-wider text-white/80">Página</span>
        </div>
        <div className="flex items-center gap-1.5">
          <span className="block h-[8px] w-[8px] rounded-full bg-[#d97706]" />
          <span className="font-[family-name:var(--font-pixel)] text-[8px] tracking-wider text-white/80">Etiqueta</span>
        </div>
        <div className="flex items-center gap-1.5">
          <span className="block h-[1.5px] w-4 bg-white/40" />
          <span className="font-[family-name:var(--font-pixel)] text-[8px] tracking-wider text-white/80">Backlink</span>
        </div>
        <div className="flex items-center gap-1.5">
          <span className="block h-[1.5px] w-4 border-b-[1.5px] border-dotted border-white/40" />
          <span className="font-[family-name:var(--font-pixel)] text-[8px] tracking-wider text-white/80">Enlaces en común</span>
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className="absolute inset-0 font-[family-name:var(--font-sans)] text-paper-bright">
      ...
      <div className="px-[20px] pt-[42px]">
        ...
        <h1 className="mt-2 font-[family-name:var(--font-serif)] text-[30px] font-light leading-[1.15] text-white">
          Tu historia<br />entre estrellas
        </h1>
        <div className="mt-4 flex items-center gap-3">
          <span className="block h-px w-6 bg-white/30" />
          <p className="font-[family-name:var(--font-serif)] text-[13px] italic text-white/50">
      ...
      <div className="absolute top-[200px] left-0 right-0 bottom-[84px] pointer-events-none">
        <div className="absolute inset-0 blur-[6px] opacity-35">
          ...
          <div className="relative h-full pl-[50px]">
            {/* Vertical line */}
            <div className="absolute left-[38px] top-0 bottom-0 w-px bg-white/15" />
            ...
            <div className="relative pt-[30px]">
              ...
              <h3 className="mt-2 font-[family-name:var(--font-serif)] text-[24px] text-white">Abrir la app</h3>
              <p className="mt-1 font-[family-name:var(--font-serif)] text-[12px] italic text-white/50 max-w-[200px]">
            ...
            <div className="relative pt-[40px]">
              ...
              <h3 className="mt-2 font-[family-name:var(--font-serif)] text-[24px] text-white leading-tight">Primer diario creado</h3>
              <p className="mt-1 font-[family-name:var(--font-serif)] text-[12px] italic text-white/50 max-w-[220px]">
            ...
            <div className="relative pt-[40px]">
              ...
              <h3 className="mt-2 font-[family-name:var(--font-serif)] text-[24px] text-white">Primera página escrita</h3>
              <p className="mt-1 font-[family-name:var(--font-serif)] text-[12px] italic text-white/50 max-w-[200px]">
...
function PhoneBottomNav({ activeScreen }: { activeScreen: string }) {
  ...
  return (
    <div className="absolute bottom-0 left-0 right-0 h-[84px] bg-[#07070a] flex items-start justify-around px-2 pt-2 z-40 border-t border-white/5">
      {tabs.map((tab) => {
        ...
        return (
          <button key={tab.id} className="group flex flex-col items-center justify-start gap-1 w-[60px]">
            <div
              className={`flex items-center justify-center w-[40px] h-[32px] rounded-full transition-colors ${
                isActive ? "bg-star/15 text-star" : "text-white/40 group-hover:text-white/70"
              }`}
            >
              {tab.icon}
            </div>
            <div className="flex flex-col items-center h-[18px]">
              <span
                className={`font-[family-name:var(--font-serif)] text-[10px] tracking-wide transition-colors ${
                  isActive ? "text-star font-bold italic" : "text-white/50"
                }`}
              >
                {tab.label}
              </span>
  ...
  return (
    <div className={className}>
      <div className="relative w-full rounded-[2.1rem] bg-gradient-to-b from-[#202024] to-[#08080a] p-[6px] shadow-[0_30px_60px_-15px_rgba(0,0,0,0.85)] ring-1 ring-white/10">
        ...
        <div
          ref={screenRef}
          className="relative overflow-hidden rounded-[1.75rem] bg-[#050505] font-[family-name:var(--font-sans)] text-paper-bright"
          style={{ aspectRatio: `${DESIGN_W} / ${DESIGN_H}` }}
        >
          <MockupStarfield className="absolute inset-0 h-full w-full opacity-80" />
